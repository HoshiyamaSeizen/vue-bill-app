...
<template>
	<div class="container">
		...
		<router-link v-if="clients.length" class="link next-btn" to="/bill">Next &#8594; Calculate cost</router-link>
		<router-link v-else class="link next-btn" to="/persons">Add persons</router-link>
	</div>
</template>
